...
public class EmployeeModuleActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_module_admin);
        ...
        //BottomNavigationViewHelperAdmin.disableShiftMode(navigation_service_eng);
    }
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_attendances:
                    intent = new Intent(EmployeeModuleActivityAdmin.this,PastAttendanceActivityAdmin.class);
            ...
            if(type.equals("login")){
                ...
                if(userId.trim().length() > 0 && password.trim().length() > 0){
                    ...
                    if(result.charAt(0)=='L')
                    {
                        ...
                        Intent intent = new Intent(EmployeeModuleActivityAdmin.this,RecordedCallsActivity.class);
                        //intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);

                        Toast.makeText(EmployeeModuleActivityAdmin.this,"You have successfully logged in" ,Toast.LENGTH_LONG ).show();

                    }else {
                        Toast.makeText(EmployeeModuleActivityAdmin.this,"Password is Incorrect" ,Toast.LENGTH_LONG ).show();
                        /*
                    ...
                    Toast.makeText(EmployeeModuleActivityAdmin.this,f ,Toast.LENGTH_LONG ).show();
